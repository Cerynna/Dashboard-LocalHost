...
<ul id="slide-out" class="side-nav fixed z-depth-2">
    <li class="center no-padding">
        <div class="grey darken-2 white-text" style="height: 180px;">
            <div class="row">
                <img style="margin-top: 5%;" width="100" height="100" src="../recup%20banban/Ressource/linux.png" class="circle responsive-img"/>
    ...
    <!-- Item dashboard -->
    <li id="dash_dashboard"><a class="waves-effect" href="../recup%20banban/index.php"><b>Dashboard</b></a></li>
